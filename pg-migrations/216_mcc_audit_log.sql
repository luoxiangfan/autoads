...
CREATE TABLE IF NOT EXISTS mcc_audit_logs (
  ...
  -- 操作详情
  action_details JSONB,  -- JSON 格式的操作详情
  old_values JSONB,  -- JSON 格式的旧值（更新/删除时）
  new_values JSONB,  -- JSON 格式的新值（创建/更新时）
...
VALUES ('216_mcc_audit_log', CURRENT_TIMESTAMP)
