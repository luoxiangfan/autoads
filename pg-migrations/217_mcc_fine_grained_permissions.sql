...
ALTER TABLE user_tenant_memberships ADD COLUMN IF NOT EXISTS custom_permissions JSONB;  -- JSON 格式的特殊权限
...
CREATE TABLE IF NOT EXISTS user_permissions (
  ...
  expires_at TIMESTAMP,  -- 权限过期时间（NULL 表示永久）
...
VALUES ('217_mcc_fine_grained_permissions', CURRENT_TIMESTAMP)
