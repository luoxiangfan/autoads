...
export type KeywordSourceTier = 'T0' | 'T1' | 'T2' | 'T3' | 'T4A' | 'T4B' | 'DERIVED' | 'UNKNOWN'
...
const EXACT_SOURCE_PRIORITY: Record<string, SourcePriorityRule> = {
  ...
  GLOBAL_KEYWORD: { score: 65, tier: 'T3' },
  GLOBAL_KEYWORDS: { score: 65, tier: 'T3' },
  GLOBAL_CORE: { score: 65, tier: 'T3' },
  GLOBAL_CORE_BRANDED: { score: 65, tier: 'T3' },
  GLOBAL_CATEGORY_BRANDED: { score: 65, tier: 'T3' },
  SCORING_SUGGESTION: { score: 62, tier: 'T3' },
  BRANDED_INDUSTRY_TERM: { score: 62, tier: 'T3' },
  ...
  KEYWORD_POOL: { score: 55, tier: 'DERIVED' },
  LEGACY_BUCKET: { score: 45, tier: 'DERIVED' },
  MERGED: { score: 35, tier: 'DERIVED' },
  BRAND_SEED: { score: 25, tier: 'DERIVED' },
  MODEL_FAMILY_GUARD: { score: 58, tier: 'DERIVED' },
}

const PREFIX_SOURCE_PRIORITY: Array<{ prefix: string; rule: SourcePriorityRule }> = [
  { prefix: 'KEYWORD_PLANNER', rule: { score: 90, tier: 'T1' } },
  { prefix: 'GLOBAL_', rule: { score: 65, tier: 'T3' } },
]

const LEGACY_EXACT_SOURCE_PRIORITY: Record<string, SourcePriorityRule> = {
  SCORING_SUGGESTION: { score: 110, tier: 'T3' },
  KEYWORD_POOL: { score: 100, tier: 'DERIVED' },
